...
const DeleteConfirmationModal = ({ onConfirm, onCancel, jobTitle, isDeleting }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="glass-card card-effect p-8 max-w-md w-full">
        ...
        <div className="flex gap-3">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className="flex-1 bg-red-600 text-white py-3 rounded-lg font-semibold text-base hover:bg-red-700 transition-colors flex items-center justify-center"
            disabled={isDeleting}
          >
            {isDeleting ? (
              <>
